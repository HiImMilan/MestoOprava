...
$sql = "SELECT * FROM problems ORDER BY ((latitude-$lat)*(latitude-$lat)) + ((longitude - $longitude)*(longitude - $longitude)) ASC LIMIT 50"; //https://gist.github.com/statickidz/8a2f0ce3bca9badbf34970b958ef8479
$result = $db->query($sql);
